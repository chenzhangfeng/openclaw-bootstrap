...
- 当前任务组：`2. Windows fat 正式包闭环` / `prepare-build 自动化设计`
- 当前领域：`windows-portable`
- 当前执行单元：
  - 类型：`slice`
  - 编号：`SLICE-005`
- 当前分支：`main`
- 当前 commit：`cf920a30a5ff90993a3a05b5d500e90397f04998`
- 当前相关文档：
  - `README.md`
  - `PLANNING.md`
  - `OUTLINE.md`
...
- 下一步最小动作：
  - 实现 `tools/environment-assets/windows/prepare-windows-build-assets.ps1`，并将 `build/build-windows.ps1` 默认接到 auto-prepare 流程，同时保留 `-SkipPrepare`。
